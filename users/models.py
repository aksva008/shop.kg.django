...
class CustomUser(AbstractUser):
    ...
    english_level = models.CharField(max_length=50, blank=True, null=True, verbose_name="Уровень английского")
    description = models.TextField(blank=True, null=True, verbose_name="Описание о себе")
    experience = models.PositiveIntegerField(blank=True, null=True, verbose_name="Опыт работы (лет)")
